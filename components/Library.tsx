...
export default function Library({ onAddItem, onRemoveSelected, onAutoPatch }) {
  const handleDragStart = (e, fixture) => {
    ...
    const img = new Image();
    img.src = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(ICONS[fixture.icon])}`;
    img.width = 26;
    img.height = 26;
  ...
  return (
    <div className="card pad">
      ...
      <div className="tools">
        ...
        <button className="btn" onClick={onAutoPatch}>Auto‑patch DMX</button>
        <button className="btn danger" onClick={onRemoveSelected}>Remover selecionado</button>
      </div>
      <div className="list">
        {FIXTURES.map((fixture) => (
          ...
          >
            ...
            <div>
              <div style={{ fontWeight: 600, fontSize: '12px' }}>{fixture.name}</div>
